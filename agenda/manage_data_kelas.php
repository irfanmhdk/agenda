...
<header>
    <div class="sidebar">
        ...
        <div class="dropdown-container">
            ...
            <a class="active" href="manage_data_kelas.php">Data Kelas</a>
    ...
    <table style="box-shadow: 7px 7px 5px lightgrey;">
        ...
        foreach($result as $d){ ?>
            <tr>
                ...
                <td><a href="hapus_data_kelas.php?id=<?= $d['id_kelas'] ?>"><button class="btn1" name="submit" style="font-size: 11px; background-color: #cc3300;"><i class="fa fa-trash"> HAPUS</i></button></form></td>
            </tr>
        <?php } ?>
    </table>
    </div>
