<?php 
    ...
    INNER JOIN tb_guru ON tb_agenda.nip = tb_guru.nip INNER JOIN tb_kelas ON tb_agenda.id_kelas = tb_kelas.id_kelas WHERE tb_kelas.nama_kelas LIKE '%".$search."%' AND tb_agenda.nip='$nip';";
