        ...
        foreach($result as $d){ ?>
            <tr>
                ...
                <td><a href="edit_data_mapel.php?id=<?= $d['id_mapel'] ?>"><button class="btn1" name="submit" style="font-size: 11px;background-color: #ffcc00;color: #000000;"><i class="fa fa-edit"> EDIT</i></button></a>
                 <a href="hapus_mapel.php?id=<?= $d['id_mapel'] ?>"><button class="btn1" onclick="return confirm('Anda Akan Menghapus Data, Yakin?')" name="submit" style="font-size: 11px; background-color: #cc3300;"><i class="fa fa-trash"> HAPUS</i></button></td>
            </tr>
        <?php } ?>
    </table>
    </div>
