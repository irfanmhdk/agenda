<?php
    ...
    $ResultsController = mysqli_query($Conn, "SELECT * FROM tb_mapel");
    ...
    $query = "SELECT * FROM tb_mapel LIMIT $offset, $per_page";
    ...
    <table style="box-shadow: 7px 7px 5px lightgrey;">
        ...
        foreach($result as $d){ ?>
            <tr>
                ...
                <td><a href="hapus_mapel.php?id=<?= $d['id_mapel'] ?>"><button class="btn1" onclick="return confirm('Anda Akan Menghapus Data, Yakin?')" name="submit" style="font-size: 11px; background-color: #cc3300;"><i class="fa fa-trash"> HAPUS</i></button></form></td>
            </tr>
        <?php } ?>
    </table>
    </div>
